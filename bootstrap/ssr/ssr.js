...
const Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="p-5"><h1 class="text-xl uppercase font-bold">This is ${escape$1(name)} test</h1> ${validate_component(Link, "Link").$$render(
    $$result,
    {
...
const Post = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const route = window.route;
  let { appName = "LaravelSvelte" } = $$props;
  if ($$props.appName === void 0 && $$bindings.appName && appName !== void 0)
    $$bindings.appName(appName);
  return `${$$result.head += `<!-- HEAD_svelte-21nuvt_START -->${$$result.title = `<title>${escape$1(appName)}</title>`, ""}<meta name="description" content="Your page description"><!-- HEAD_svelte-21nuvt_END -->`, ""} <main class="p-5"><h1 class="text-xl" data-svelte-h="svelte-kjglnq">This is post page</h1> <h1>Welcome to Laravel ${escape$1(stack)} stack</h1> ${validate_component(Link, "Link").$$render(
    $$result,
    {
...
const Ziggy$1 = {
  ...
  routes: {
    ...
    post: { uri: "post", methods: ["GET", "HEAD"] }
  }
};
  ...
  (page) => createInertiaApp({
    ...
    resolve: (name2) => {
      const pages = /* @__PURE__ */ Object.assign({
        ...
        "./Pages/Post.svelte": __vite_glob_0_1
      });
